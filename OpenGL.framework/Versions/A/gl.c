...
const GLubyte *glGetString(GLenum name) {
	const char *s;
	switch (name) {
		case GL_VENDOR: s = "Paul"; break;
		case GL_RENDERER: s = "Paul"; break;
		case GL_VERSION: s = "2.1 NVIDIA-1.6.26"; break;
		case GL_EXTENSIONS: s = gl_extensions; break;
		default: s = NULL;
	}
